...
Funcionario = db.define_table('funcionario',
				...
				Field('funcao', 'string'),
				Field('salario_funcionario', 'double', writable=False, readable=False, notnull=True, default=0),
				Field('vale_saida_funcionario', 'double', writable=False, readable=False, notnull=True, default=0),
				Field('vale_caderno_funcionario', 'double', writable=False, readable=False, notnull=True, default=0),
				Field('valor_recebido_chegada', 'double', writable=False, readable=False, notnull=True, default=0),
				auth.signature)
